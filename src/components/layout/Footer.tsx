      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link
              to="/"
              className="flex items-center font-heading font-bold text-xl mb-4"
            >
              <span className="gradient-text">Voxio</span>
              <span className="ml-1">AI</span>
            </Link>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Transform customer interactions with AI-powered chat and voice
              assistants.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  to="/products/chatbot"
                  className="text-base text-gray-500 dark:text-gray-400 hover:text-brand-purple dark:hover:text-brand-purple transition-colors"
                >
                  Chatbot
                </Link>
              </li>
